...
\begin{tikzpicture}[>=stealth]
	...
	\def\width{5.25cm}
	\foreach \y in {-1,-7,-13}{
		\draw[separator] (-\width,\y) -- (\width,\y); 
	}
	\large
	\node[rotate=90] at (-\width,-4cm) {Background}; 
	\node[rotate=90] at (-\width,-10cm) {Novel Contributions}; 
\end{tikzpicture}
\end{document}