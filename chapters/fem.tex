...
Such a general framework as Galerkin's method, however, does not provide a way to define the approximation space $V_h$. The finite element method fill this gap by providing a systematic process for constructing the finite-dimensional spaces $V_h$ in ways that are amenable to efficient computer implementation. 
...
\subsection{\todo{The Conjugate Gradient Method}}

% --- conjugate gradient on 2-dimensional diffusion problem --- 
\begin{figure}
\centering
\includegraphics[width=.85\textwidth]{figs/conj_grad.pdf}
...
\subsection{\todo{The Stabilized Bi-Conjugate Gradient Method}}
\subsection{\todo{Multigrid}}
\end{document}