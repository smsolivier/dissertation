...
For example, if $X_h = V_1$, the linear continuous finite element space, then $\mathcal{N}_h$ is the set of locations, $\x_i$, in the domain corresponding to a vertex in the mesh and $\mathcal{Q}(K) = \Qbb{p}(K)$. 
