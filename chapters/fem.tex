...
On boundary faces, the jump and average are set to 
	...
	\end{equation}
and likewise for vector-valued functions on the boundary. \todo{jumps and averages}
	\begin{equation} \label{fem:jumps_avg_id}
		\jump{uv} = \jump{u}\avg{v} + \avg{u}\jump{v} \,. 
	\end{equation}
