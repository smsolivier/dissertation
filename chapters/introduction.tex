...
In addition, stimulated scattering events, where the probability of the events occurring depends on the density of nearby radiation, lead to quadratic nonlinearities in the transport equation \cite{1986JQSRT..36..273K}. 
...
% In that same time span, the number of GPU-accelerated supercomputers increased from none to 134 \todo{(citation needed, dates likely wrong)}. 
