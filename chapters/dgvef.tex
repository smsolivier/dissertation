...
Setting $\vec{\tau} = \jump{\widehat{\E\varphi}\hat{n} - \E\varphi\hat{n}}$ and $\vec{\chi} = \avg{\widehat{\E\varphi}\hat{n} - \E\varphi\hat{n}}$ and using the definitions of the lifting operators, Eq.~\ref{dgvef:weak_strong} can be written entirely in terms of volumetric integrals as: 
	\begin{equation}
